...
def multi_epoch_flow(mode):
    ...
    d.text((60, 30), "Election, work, and revenue span two epochs",
    ...
    d.text((60, 400),
           "Applying the halving = changing the routing table before step 4 runs. See sequential-deduction next.",
