...
## Accessibility
The Spectrum can be obtained directly from any Qubic node ([Core/Full, Lite, or Bob](/learn/nodes#node-implementations)) or downloaded from [storage.qubic.li](https://storage.qubic.li/network/).
