...
| **Qools** | Qubic tools and utilities platform | [qools.org](https://www.qools.org/en) | Tools |
| **Rubic** | Rust-based Qubic wallet with encryption | [GitHub](https://github.com/MatthewDarnell/rubic) | Wallet |
